...
const ClientBlockCards = () => {
  ...
  const cards: ClientsCardProps[] = [
    {
      title: t('clientsCards.titleCard1'),
      percent: '18%',
      description: t('clientsCards.descriptionCard1'),
    ...
    {
      title: t('clientsCards.titleCard2'),
      percent: '100%',
      description: t('clientsCards.descriptionCard2'),
    ...
    {
      title: t('clientsCards.titleCard3'),
      percent: '88%',
      description: t('clientsCards.descriptionCard3'),
    ...
    {
      title: t('clientsCards.titleCard4'),
      percent: '15%',
      description: t('clientsCards.descriptionCard4'),
    ...
    {
      title: t('clientsCards.titleCard5'),
      percent: '100%',
      description: t('clientsCards.descriptionCard5'),
    ...
    {
      title: t('clientsCards.titleCard6'),
      percent: '25%',
      description: t('clientsCards.descriptionCard6'),
